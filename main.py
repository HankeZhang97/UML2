...
class ADATree:
    ...
    def __scope_tree(self,string,parent,search_offset=0):
        pass

class ADATreejs(ADATree):
    def __init__(self):
        pass

    def scope_tree(self,string, 
                parent, 
                search_offset=0 ):
...
def usage():
    print("This is a help information!")
    print("Please usage " + sys.argv[0] + " -f [filename of js file] --output [output path]") 


def main():
    try:
        opts, args = getopt.getopt(sys.argv[1:], "hf:o:", ["help", "output="])
